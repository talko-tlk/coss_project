...
% will run into a different network with similar properties
    ...
    %% 1-3 Small_World
        Small_World_network_1000nodes; % Generation of the Small_World_network
...
% will run into a different network with similar properties 
    ...
    %% 2-3 Small_World    
        %% 2-3-1 Generation of the 12-node Small_World
            Small_World_network_12nodes
         
        %% 2-3-2 Small_World_self_resilience
            Small_World_network_12nodes_self_resilience; % Analyse the 12node Erdos_Renyi_network without external forces
         
        %% 2-3-3 Small_World_external_forces
            Small_World_network_12nodes_external_forces; % Analyse the 12node Erdos_Renyi_network with external forces
